...
<body>
    <div class="container">
        ...
        <div class="info-box">
            ...
            <p>Este sistema envía automáticamente las 15 consultas sobre el proceso electoral de representantes de MYPE al correo: <strong>{{ config('mype.target_email') }}</strong></p>
        ...
        <div class="info-box">
            ...
            <p><strong>Intervalo:</strong> Entre {{ config('mype.min_days_between_emails') }} y {{ config('mype.max_days_between_emails') }} días</p>
            <p><strong>Horario:</strong> 10:00 AM (verificación diaria)</p>
            <p><strong>Remitente:</strong> {{ config('mype.sender_name') }}</p>
        </div>
